...
class ReportIncomeByProcedure(models.AbstractModel):
    ...
    _name = 'report.beauty_clinic_management.report_income_by_procedure'
...
#         }
#         return self.env['report'].render('beauty_clinic_management.income_by_procedure_qweb', docargs)
