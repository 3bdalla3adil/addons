    ...
    def _select(self):
        return '''
                SELECT
                    ...
                    -line.balance / NULLIF(COALESCE(uom_line.factor, 1) / COALESCE(uom_template.factor, 1), 0.0) * currency_table.rate AS price_average,
...
# =================================================================================================
    ...
    # ToDo:NEED TO BE ADAPTED WITH Odoo 17
    ...
    #             COALESCE(cr.rate, 1) as currency_rate, sub.residual as residual, sub.commercial_partner_id as commercial_partner_id, sub.clinic as clinic,  sub.insurance_company as insurance_company
    #     """
    #     return select_str
    ...
    #                 ai.invoice_partner_bank_id,ai.clinic as clinic,  ai.insurance_company as insurance_company,
    ...
    #                 ai.commercial_partner_id, partner.country_id, ai.clinic, ai.insurance_company
    #     """
    #     return group_by_str
