...
patch(CalendarCommonRenderer.prototype, 'calendar_commCalendarRenderer', {
    ...
    _displayTimeSlots: function (e) {
        ...
        session.rpc('/web/dataset/call_kw/clinic.slot/get_clinics_slot',{
            model: 'clinic.slot',
    ...
    _fcWidgetContent: async function (ev) {
        ...
        await session.rpc('/web/dataset/call_kw/clinic.slot/get_clinics_slot_validation',{
            model: 'clinic.slot',
    ...
    async get_clinics_slot_details(checkResizeWindow) {
        ...
        await session.rpc('/web/dataset/call_kw/clinic.slot/get_clinics_slot',{
            model: 'clinic.slot',
            method: 'get_clinics_slot',
