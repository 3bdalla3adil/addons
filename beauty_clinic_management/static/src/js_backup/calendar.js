...
//
    ...
    var calendar_custCalendarRenderer = CalendarRenderer.extend({
        ...
        get_clinics_slot_details: function (checkResizeWindow) {
...
//                        'height': '449px',
                    ...
                    self.$el.parent().find('.fc-slats').css({'width': '260px','index':'0px'});
...
//                                    }
//                                    console.log("=============clinicResult=====a====",a)
//                                    console.log("==========clinicDiv=======1=====",clinicDiv)
//                                    clinicDiv.append("<p>Data Here 1.</p>")
//                                    clinicDiv.append("<p>Data Here 2.</p>")
//                                    console.log("==========clinicDiv=======2=====",clinicDiv)
////                                    clinicDiv.append(a)
//                                }
//                            })
...
//                            self.$el.parent().find('.fc-slats').prepend(clinicDiv);
                            self.$el.parent().find('.fc-slats').before(clinicDiv);
                        }
                        else {
...
//                            clinicDiv.css('margin-left','50px !important');
//                            copyTimeSlot.prepend(clinicDiv);
                            var left_css = j*262
...
//                  we have multiple appointment create for same clinic on same time slots
...
//                            $(dtl).find("td:eq(0)").addClass('TimeSlotTD).attr({'id': clinicID});
//                            $(dtl).find("td:eq(1)").addClass('TimeSlotTD').attr({'id': clinicID});
                         });
                    });
        ...
        _render: function () {
            var self = this;
            console.log("==========_render==========");
            var renderData = this._super.apply(this, arguments).then(self.get_clinics_slot_details());
            return renderData;
        },
    });
...
//                    context['default_clinic_id'] = parseInt(a[0].id);
//                }
